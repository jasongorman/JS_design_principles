...
var _TestSequencer = _interopRequireDefault(require('./TestSequencer'));
...
const getTestPaths =
  ...
  (function() {
    var _ref = _asyncToGenerator(function*(
      ...
      const data = yield source.getTestPaths(globalConfig, changedFiles);
...
var _default =
  ...
  (function() {
    var _runJest = _asyncToGenerator(function*({
      ...
      const sequencer = new _TestSequencer.default();
      let allTests = [];
