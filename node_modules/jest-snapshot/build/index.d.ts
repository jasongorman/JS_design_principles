...
declare const JestSnapshot: {
    ...
    toMatchSnapshot: (this: Context, received: any, propertyMatchers?: any, testName?: string | undefined) => {
        message: () => string;
        name: string;
        pass: boolean;
        report: () => string;
    ...
    toThrowErrorMatchingSnapshot: (this: Context, received: any, testName: string | undefined, fromPromise: boolean) => {
        message: () => string;
        name: string;
        pass: boolean;
        report: () => string;
